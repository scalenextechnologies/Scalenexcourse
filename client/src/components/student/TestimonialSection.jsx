...
const TestimonialSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>Hear from learners as they discuss their transformational experiences, successes, and how our <br /> platform has made a difference in their life.</p>
