            ...
            <div className='space-y-5'>
                <div className='flex flex-wrap gap-5 items-center'>
                    ...
                    <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md'>
                        ...
                        <div>
                            <p className='text-2xl font-medium text-gray-600'>
                                {currency}{dashBoardData.totalEarnings} {/* assuming it's a number */}
                            </p>
                ...
                <div className='flex flex-col items-center max-w-4xl w-full over rounded-md bg-white border border-gray-500/20'>
                        ...
                        <tbody className='text-sm text-gray-500'>
                            {dashBoardData.enrolledStudentsData.map((item, index) => (
                                <tr key={index} className='border-b border-gray-500/20'>
                                    <td className='md:px-4 px-2 py-3 text-center'>
                                        {index + 1}
                                    </td>
