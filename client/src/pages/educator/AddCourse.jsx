        ...
        setChapters(prevChapters =>
            prevChapters.map((chapter) => {
                if (chapter.chapterId === currentChapterId) {
                    ...
                    chapter.chapterContent.push(newLecture); // Add the lecture to the chapter
                }
                return chapter;
            })
        );
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
                <div className=' flex flex-col gap-1'>
                    ...
                    <input onChange={e => setCourseTitle(e.target.value)} value={courseTitle}
                        type='text' placeholder='Type here' className='outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500' />
                </div>
                <div className=' flex flex-col gap-1'>
                ...
                <div className='flex items-center justify-between flex-wrap'>
                    ...
                    <div className='flex md:flex-row flex-col items-center gap-3'>
                        ...
                        <label htmlFor='thumbnailImage' className='flex items-center gap-3'>
                            <img src={assets.file_upload_icon} alt="file_upload" className='p-3 bg-blue-500 rounded' />
                                    ...
                                    {chapter.chapterContent.map((lecture, lectureIndex) => (
                                        <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                                            <span>
                                                ...
                                                <a href={lecture.lectureUrl} target='_blank' className='text-blue-800'>Link</a> - 
                        ...
                        <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
                            ...
                            <div className='mb-2'>
                                ...
                                <input type="checkbox"
                                    ...
                                    onChange={(e) => setLectureDetails({ ...lectureDetails, isPreviewFree: e.target.checked ? 'true' : 'false' })}
                                />
                            </div>
                            <button
                                type='button' className='w-full bg-blue-400 text-white px-4 py-2 rounded' 
                               onClick={addLecture}
                            >Add</button>
